...
static int impd1_probe(struct lm_device *dev)
{
	...
	impd1->clks[0] = clkdev_add(&impd1->vcos[0], NULL, "lm%x:01000",
					dev->id);
	impd1->clks[1] = clkdev_add(&fixed_14745600, NULL, "lm%x:00100",
					dev->id);
	impd1->clks[2] = clkdev_add(&fixed_14745600, NULL, "lm%x:00200",
					dev->id);

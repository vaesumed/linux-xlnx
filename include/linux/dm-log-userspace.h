 ...
 * ((struct dm_ulog_request) + (additional data)).
 */
 ...
 *
 * The payload data trailing the dm_ulog_request structure is a string
 * containing the argv arguments.  The UUID contained in the dm_ulog_request

...
static inline void wlp_set_attr_hdr(struct wlp_attr_hdr *hdr, unsigned type, size_t len)
{
 ...
 */
static size_t wlp_set_wss_info(struct wlp_attr_wss_info *attr, struct wlp_wss *wss)
{
	size_t datalen;

//++=======================================================================
// Program Name:  NetWare Redirector for Linux
// File Name:     NWCLNX.H
// Version:       v1.00
// Authors:       Sheffer Clark (based on nwcapi.h)
//
// Abstract:      This module contains all typedefs and constants for the
//                NetWare Client APIs.
//
// Notes:         This interface is accessed using ...
//
// Revision History:
//
//
...
#if 0				//sgled hack
#include <nwapidef.h>
#include <ncpltype.h>		//sgled note, not compatable with novfs

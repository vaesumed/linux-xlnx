...
extern ssize_t Daemon_Receive_Reply(struct file *file, const char *buf, size_t nbytes, loff_t * ppos);
extern ssize_t Daemon_Send_Command(struct file *file, char *buf, size_t len, loff_t * off);

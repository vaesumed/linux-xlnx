...
/* not used */
struct novfs_close_request {
	struct novfs_command_header command;
	void *file_handle;
};

/* not used */
struct novfs_close_reply {
...
/* not used */
struct novfs_open_connection_by_addr_request {
	struct novfs_command_header command;
	unsigned int address;
};

/* not used */
struct novfs_open_connection_by_addr_reply {
	struct novfs_command_reply_header reply;
	unsigned char server_name[64];
	unsigned char tree_name[64];
	void *conn_handle;
};

/* not used */
struct novfs_open_connection_by_name_request {
	struct novfs_command_header command;
...
/* not used */
struct novfs_open_connection_by_name_reply {
	struct novfs_command_reply_header reply;
	unsigned char tree_name[64];
	void *conn_handle;
};
...
struct novfs_get_cache_flag_request {
	struct novfs_command_header command;
	int path_len;
...
struct novfs_xa_set_request {
	struct novfs_command_header command;
	unsigned int ttl_write_data_size;
